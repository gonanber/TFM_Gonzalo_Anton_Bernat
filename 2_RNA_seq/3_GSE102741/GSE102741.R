...
save(se, file = "../0_data/seGSE102741.rda")

################################################################################
# ANOTACION                                                                    #
################################################################################

load("../0_data/seGSE102741.rda")
...
save(se2, file = "../0_data/se2GSE102741.rda")

################################################################################
# ANÁLISIS DE EXPRESIÓN DIFERENCIAL CON LIMMA-VOOM                             #
################################################################################
load("../0_data/se2GSE102741.rda")
...
fit2 <- eBayes(fit2)
head(fit2)
#save(fit2, file = "../../Microarrays/fits/GSE102741.rda")
