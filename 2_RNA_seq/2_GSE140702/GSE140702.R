...
save(se, file = "../0_data/seGSE140702_sin_outliers.rda")

################################################################################
# ANOTACION                                                                    #
################################################################################

load("../0_data/seGSE140702_sin_outliers.rda")
...
save(se2, file = "../0_data/se2GSE140702.rda")


################################################################################
# ANÁLISIS DE EXPRESIÓN DIFERENCIAL CON LIMMA-VOOM                             #
################################################################################
load("../0_data/se2GSE140702.rda")
...
fit2 <- eBayes(fit2)
head(fit2)
#save(fit2, file = "../../Microarrays/fits/GSE140702.rda")
