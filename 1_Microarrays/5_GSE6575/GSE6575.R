...
save(eset2, file = "../0_data/eset2_GSE6575.rda")
...
genedata <- genedata[,c("Gene Symbol","ID")]
genedata$Symbol <- sub(" ///.*","",genedata$`Gene Symbol`)
...
fit2 <- eBayes(fit2)
#save(fit2, file = "../fits/GSE6575.rda")

todos_fit2 <- list()
todos_fit2[["GSE6575"]] <- fit2
