...
load("../../00_Datos/GSE123302_marbles.rda")
...
save(eset2, file = "../../00_Datos/eset2_marbles.rda")
...
load("../../00_Datos/eset2_marbles.rda")
eset <- eset2
datos <- pData(eset)
exp <- exprs(eset)
anot <- fData(eset)
...
fit2 <- eBayes(fit2)
save(fit2, file = "../../3_Genera_todos_fit/fit_GSE1233022.rda")
