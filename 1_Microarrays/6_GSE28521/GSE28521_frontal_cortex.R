...
load("../0_data/GSE28521_frontal_cortex.rda")
eset <- GSE28521
...
save(eset2, file = "../0_data/eset2_frontal_cortex.rda")
...
load("../0_data/eset2_frontal_cortex.rda")
exp <- exprs(eset2)
datos <- pData(eset2)
...
fit2 <- eBayes(fit2)
#save(fit2, file = "../fits/GSE285212.rda")

todos_fit2 <- list()
todos_fit2[["GSE28521_frontal_cortex"]] <- fit2
