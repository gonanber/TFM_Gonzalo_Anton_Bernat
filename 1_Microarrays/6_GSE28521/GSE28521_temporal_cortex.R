...
load("../../00_Datos/GSE28521_temporal_cortex.rda")
eset <- GSE28521
...
save(eset2, file = "../../00_Datos/eset2_temporal_cortex.rda")
...
load("../../00_Datos/eset2_temporal_cortex.rda")
exp <- exprs(eset2)
datos <- pData(eset2)
...
fit2 <- eBayes(fit2)
save(fit2, file = "../../3_Genera_todos_fit/fit_GSE285213.rda")
