...
save(eset2, file = "../../00_Datos/eset2_GSE18123_2.rda")
...
load("../../00_Datos/eset2_GSE18123_2.rda")
exp <- exprs(eset2)
datos <- pData(eset2)
...
fit2 <- eBayes(fit2)
save(fit2, file = "../../3_Genera_todos_fit/fit_GSE18123_2.rda")
